    ...
    <div className='flex items-center flex-row h-64 p-10 font-inter'>
      <div className='w-1/2 h-64'>
        ...
        <div className='mt-6 flex h-14 font-medium'>
            ...
            <p className={hover ? 'bg-purple cursor-pointer w-40 rounded-full flex items-center justify-between pl-1 pr-1 ml-8 transition-all duration-300' : 'bg-purple cursor-pointer w-40 rounded-full flex items-center justify-between pl-6 pr-1 ml-8 transition-all duration-300'} onMouseEnter={handleHover} onMouseLeave={handleHover}><span className={hover ? 'hidden' : ''}>Active</span> <span className={hover ? 'bg-dp rounded-full px-4 py-3 w-full flex items-center justify-center' : 'bg-dp rounded-full px-4 py-3'}>12</span></p>
        </div>
      </div>
